...
export function ApplicationProvider({children}){
    ...
    return(
        <ApplicationContext.Provider value ={{posts: state.currentPosts, homePageDispatch, token: authState.token, loginStatus: authState.isLoggedIn, authDispatch}} > {children}</ApplicationContext.Provider>
    )
